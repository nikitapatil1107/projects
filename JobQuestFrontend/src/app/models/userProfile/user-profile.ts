...
export class UserProfile {
  ...
  get getWorkExpList(): UserWorkExperience[] {
    return this.workExpList;
  }

  set setWorkExpList(workExpList: UserWorkExperience[]) {
    this.workExpList = workExpList;
  }

  get getUserEducationList(): UserEducation[] {
    return this.userEducationList;
  }

  set setUserEducationList(userEducationList: UserEducation[]) {
    this.userEducationList = userEducationList;
  }
}
