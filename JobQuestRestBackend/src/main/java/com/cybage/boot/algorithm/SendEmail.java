package com.cybage.boot.algorithm;
...
//			Create message :  
	...
	public boolean sendAccpetRejectEmail(String to, String subject, String messag) {
		
		String from = "cybtraining@evolvingsols.com", sub = subject, msg = messag;
